...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="public/vendors/iconfonts/ionicons/dist/css/ionicons.css">
    <link rel="stylesheet" href="public/vendors/iconfonts/flag-icon-css/css/flag-icon.min.css">
    ...
    <!-- inject:css -->
    <link rel="stylesheet" href="public/css/shared/style.css">
    <!-- endinject -->
    <!-- Layout styles -->
  ...
  <body>
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html">
            <img src="public/images/logo.svg" alt="logo" /> </a>
          <a class="navbar-brand brand-logo-mini" href="index.html">
            <img src="public/images/logo-mini.svg" alt="logo" /> </a>
        </div>
          ...
          <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="public/images/faces/face10.jpg" alt="image" class="img-sm profile-pic"> </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="public/images/faces/face12.jpg" alt="image" class="img-sm profile-pic"> </div>
                  <div class="preview-item-content flex-grow py-2">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="public/images/faces/face1.jpg" alt="image" class="img-sm profile-pic"> </div>
                  <div class="preview-item-content flex-grow py-2">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle" src="public/images/faces/face8.jpg" alt="Profile image"> </a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="public/images/faces/face8.jpg" alt="Profile image">
                  <p class="mb-1 mt-3 font-weight-semibold"><?php echo $thong_tin_user->ho_ten; ?></p>
                  <p class="font-weight-light text-muted mb-0"><?php echo $thong_tin_user->email; ?></p>
                </div>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="profile-image">
                  <img class="img-xs rounded-circle" src="public/images/faces/face8.jpg" alt="profile image">
                  <div class="dot-indicator bg-success"></div>
                </div>
                <div class="text-wrapper">
                  <p class="profile-name"><?php echo $thong_tin_user->ho_ten; ?></p>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="d-flex mt-3 py-2 border-bottom">
                          <img class="img-sm rounded-circle" src="public/images/faces/face3.jpg" alt="profile image">
                        ...
                        <div class="d-flex py-2 border-bottom">
                          <img class="img-sm rounded-circle" src="public/images/faces/face4.jpg" alt="profile image">
                          <div class="wrapper ml-2">
    ...
    <!-- inject:js -->
    <script src="public/js/shared/off-canvas.js"></script>
    <script src="public/js/shared/misc.js"></script>
    <!-- endinject -->
    <!-- Custom js for this page-->
    <script src="public/js/demo_1/dashboard.js"></script>
